...
export type ClientQuickAction = 'buy-tickets' | 'my-qr' | 'wallet' | 'resell' | 'pr-area' | 'profile' | 'events';
export type PrQuickAction = 'events' | 'lists' | 'wallet' | 'profile' | 'tracking' | 'client-switch';
...
const DEFAULT_PR_ACTIONS: PrQuickAction[] = ['events', 'lists', 'wallet', 'tracking', 'profile'];
