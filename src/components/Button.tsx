...
export function Button({
  ...
  if (variant === 'golden') {
    ...
    if (style?.width) outerStyle.width = style.width;
    if (style?.alignSelf) outerStyle.alignSelf = style.alignSelf;
    if (style?.marginBottom) outerStyle.marginBottom = style.marginBottom;
    if (style?.marginTop) outerStyle.marginTop = style.marginTop;
    if (style?.marginHorizontal) outerStyle.marginHorizontal = style.marginHorizontal;
    if (style?.flex) outerStyle.flex = style.flex;

    const innerStyle: ViewStyle = { ...style };
