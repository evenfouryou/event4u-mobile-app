      ...
      items: [
        {
          ...
          type: 'link' as const,
          onPress: () => Alert.alert('Info', 'Contatta support@eventfouryou.com'),
        },
        {
          id: 'feedback',
          ...
          type: 'link' as const,
          onPress: () => Alert.alert('Info', 'Invia feedback a feedback@eventfouryou.com'),
        },
        {
          id: 'about',
          ...
          label: 'Informazioni',
          type: 'link' as const,
          onPress: () => Alert.alert('Event Four You', 'Versione 1.0.0'),
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          type: 'link' as const,
          onPress: () => Linking.openURL('https://eventfouryou.com/privacy'),
        },
        {
          id: 'terms',
          ...
          type: 'link' as const,
          onPress: () => Linking.openURL('https://eventfouryou.com/terms'),
        },
      ],
    },
  ];
