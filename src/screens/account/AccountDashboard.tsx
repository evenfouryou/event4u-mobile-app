        ...
        <View style={authStyles.content}>
          <View style={authStyles.iconContainer}>
            <View style={authStyles.iconRing}>
              ...
              >
                <Ionicons name="person" size={40} color={staticColors.primary} />
              </LinearGradient>
            </View>
          </View>
          <Text style={authStyles.title}>Il tuo account</Text>
          <Text style={authStyles.subtitle}>
            Accedi per gestire il tuo profilo,{'\n'}wallet, biglietti e preferenze
          </Text>
          <View style={authStyles.buttonContainer}>
            <Button
              ...
              testID="button-account-login"
            >
              Accedi
            </Button>
          </View>
          <Pressable onPress={onNavigateRegister} testID="link-account-register" style={authStyles.registerContainer}>
