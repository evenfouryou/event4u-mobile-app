...
export default function LocationDetail() {
  ...
  if (!isMobile) {
    return (
      <div className="container mx-auto p-6 space-y-6" data-testid="page-location-detail-desktop">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-2xl font-bold" data-testid="text-location-title">
                {location.name}
              </h1>
              <p className="text-muted-foreground">Configurazione location</p>
            </div>
          </div>
          <div className="flex items-center gap-2">
            ...
            {location.siaeLocationCode && (
              <Badge variant="outline" className="gap-1">
                <Ticket className="h-3 w-3" />
                SIAE: {location.siaeLocationCode}
              </Badge>
            )}
          </div>
        </div>
          ...
          <TabsContent value="details">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Modifica i dettagli della location</CardDescription>
              </CardHeader>
              <CardContent>
                <Form {...form}>
