...
contextBridge.exposeInMainWorld('siaeAPI', {
  ...
  // PIN/PUK management - additional APIs
  unlockWithPuk: (puk, newPin, pinNumber = 1) => ipcRenderer.invoke('pin:unlockWithPuk', { puk, newPin, pinNumber }),
  getPinRetries: () => ipcRenderer.invoke('pin:getRetries'),
  
  // Card certificate and EFFF data
  getCertificate: () => ipcRenderer.invoke('bridge:getCertificate'),
  readEfff: () => ipcRenderer.invoke('bridge:readEfff'),
