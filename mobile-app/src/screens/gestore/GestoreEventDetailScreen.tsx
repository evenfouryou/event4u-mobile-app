...
export function GestoreEventDetailScreen({ eventId, onBack }: GestoreEventDetailScreenProps) {
  ...
  const allTabs: { id: TabType; label: string; icon: keyof typeof Ionicons.glyphMap; featureKey?: string }[] = [
    { id: 'overview', label: 'Overview', icon: 'home-outline' },
    { id: 'ticketing', label: 'Biglietti', icon: 'ticket-outline', featureKey: 'cassaBiglietti' },
    { id: 'guests', label: 'Ospiti', icon: 'people-outline', featureKey: 'guestList' },
    { id: 'tables', label: 'Tavoli', icon: 'grid-outline', featureKey: 'tables' },
    { id: 'staff', label: 'Staff', icon: 'person-outline', featureKey: 'staff' },
    { id: 'inventory', label: 'Inventario', icon: 'cube-outline', featureKey: 'inventory' },
    { id: 'finance', label: 'Finanze', icon: 'cash-outline', featureKey: 'finance' },
  ];

  const tabs = allTabs.filter(tab => !tab.featureKey || isModuleEnabled(tab.featureKey));
      ...
      <SafeArea edges={['bottom']} style={styles.container}>
        ...
        <View style={styles.emptyState}>
          ...
          <Text style={styles.emptyTitle}>
            {hasError ? 'Errore di caricamento' : 'Evento non trovato'}
          </Text>
          {hasError && (
            <Button
              variant="outline"
              ...
              testID="button-retry"
            >
              <Text style={{ color: colors.foreground }}>Riprova</Text>
            </Button>
          )}
        </View>
      </SafeArea>
