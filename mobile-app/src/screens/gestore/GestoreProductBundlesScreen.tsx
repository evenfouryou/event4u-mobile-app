...
import { View, Text, StyleSheet, ScrollView, Pressable, RefreshControl, Dimensions, Image, Alert } from 'react-native';
...
import api, { ProductBundle, BundleStats } from '@/lib/api';
  ...
  const loadData = async () => {
    try {
      ...
      const [bundlesData, statsData] = await Promise.all([
        api.getGestoreProductBundles(),
        api.getProductBundleStats(),
      ]);
          ...
          <>
            ...
            <View style={styles.statsGrid}>
              ...
              <GlassCard style={styles.statCard}>
                ...
                <Text style={styles.statValue}>{formatNumber(stats.totalSold)}</Text>
                    ...
                    <Card style={styles.bundleCard}>
                      ...
                      <View style={styles.bundlePricing}>
                        <View style={styles.priceRow}>
                          ...
                          <Text style={styles.originalPrice}>{formatCurrency(bundle.originalPrice)}</Text>
                        </View>
                        <View style={styles.priceRow}>
                      ...
                      <View style={styles.bundleStats}>
                        <View style={styles.bundleStat}>
                          ...
                          <Text style={styles.bundleStatValue}>{bundle.soldCount}</Text>
                          <Text style={styles.bundleStatLabel}>vendite</Text>
                        </View>
                        <View style={styles.bundleStat}>
                          <Ionicons name="cash-outline" size={16} color={colors.mutedForeground} />
                          <Text style={styles.bundleStatValue}>{formatCurrency(bundle.price * bundle.soldCount)}</Text>
                        ...
                        {bundle.endDate && (
                          <View style={styles.bundleStat}>
                            ...
                            <Text style={styles.bundleStatLabel}>{formatDate(bundle.endDate)}</Text>
                          </View>
                        )}
                      </View>
