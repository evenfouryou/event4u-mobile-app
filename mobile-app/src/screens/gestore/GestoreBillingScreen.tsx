        ...
        <View style={styles.section}>
          ...
          {showLoader ? (
            ...
            <View style={styles.emptyState}>
              ...
              <Text style={[styles.emptyText, { color: colors.mutedForeground }]}>Impossibile caricare le fatture</Text>
              <Pressable
                onPress={() => {
                  triggerHaptic('light');
                  loadInvoices();
              ...
              <Card key={invoice.id} style={styles.invoiceCard} testID={`invoice-${invoice.id}`}>
                <View style={styles.invoiceHeader}>
                  <View style={styles.invoiceInfo}>
                    ...
                    <Text style={styles.invoiceCustomer}>{invoice.clientName}</Text>
                  </View>
                ...
                <View style={styles.invoiceDates}>
                  <View style={styles.invoiceDate}>
                    ...
                    <Text style={styles.invoiceDateText}>Data: {formatDate(invoice.date)}</Text>
                  </View>
                </View>
