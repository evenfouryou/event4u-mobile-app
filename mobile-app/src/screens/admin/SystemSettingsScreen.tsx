      ...
      >
        <View style={[
          ...
          <View style={[
            ...
            <Card variant="glass" style={styles.section} testID="card-app-config">
              <View style={styles.sectionHeader}>
                <View style={[styles.sectionIcon, { backgroundColor: `${colors.primary}20` }]}>
                  <Ionicons name="settings-outline" size={24} color={colors.primary} />
                </View>
                <Text style={styles.sectionTitle} testID="text-section-app">Configurazione App</Text>
              </View>
            ...
            <Card variant="glass" style={styles.section} testID="card-email-settings">
              <View style={styles.sectionHeader}>
                <View style={[styles.sectionIcon, { backgroundColor: `${colors.success}20` }]}>
                  <Ionicons name="mail-outline" size={24} color={colors.success} />
                </View>
                <Text style={styles.sectionTitle} testID="text-section-email">Impostazioni Email</Text>
              </View>
          ...
          <View style={[
            ...
            <Card variant="glass" style={styles.section} testID="card-siae-settings">
              <View style={styles.sectionHeader}>
                <View style={[styles.sectionIcon, { backgroundColor: `${colors.accent}20` }]}>
                  <Ionicons name="shield-checkmark-outline" size={24} color={colors.accent} />
                </View>
                <Text style={styles.sectionTitle} testID="text-section-siae">Impostazioni SIAE</Text>
              </View>
              ...
              <View style={styles.inputGroup}>
                ...
                <View style={styles.counterRow}>
                  <TouchableOpacity
                    ...
                    testID="button-retry-decrease"
                  >
                    <Ionicons name="remove" size={20} color={colors.foreground} />
                  </TouchableOpacity>
                  <Text style={styles.counterValue} testID="text-retry-value">{settings.siaeDefaults.retryAttempts}</Text>
                  <TouchableOpacity
                    style={styles.counterButton}
                    onPress={() => updateSiaeDefaults('retryAttempts', Math.min(10, settings.siaeDefaults.retryAttempts + 1))}
                    testID="button-retry-increase"
                  >
                ...
                <View style={styles.reportTypeSelector}>
                  {['RCA', 'RMG', 'RPM'].map((type) => (
                    <TouchableOpacity
                      ...
                      testID={`button-report-type-${type}`}
                    >
                      <Text style={[
            ...
            <Card variant="glass" style={styles.section} testID="card-maintenance">
              <View style={styles.sectionHeader}>
                ...
                <Text style={styles.sectionTitle} testID="text-section-maintenance">Modalità Manutenzione</Text>
              </View>
              ...
              {settings.maintenanceMode && (
                <View style={styles.inputGroup}>
                  ...
                  <TextInput
                    ...
                    multiline
                    numberOfLines={3}
                    testID="input-maintenance-message"
                  />
                </View>
              )}
            </Card>

            <Card variant="glass" style={styles.section} testID="card-version-info">
              <View style={styles.sectionHeader}>
                ...
                <Text style={styles.sectionTitle} testID="text-section-version">Informazioni Versione</Text>
              </View>

              <View style={styles.versionRow}>
                <Text style={styles.versionLabel}>Versione App</Text>
                <Text style={styles.versionValue} testID="text-version-app">{settings.version}</Text>
              </View>
              <View style={styles.versionRow}>
                <Text style={styles.versionLabel}>Build Number</Text>
                <Text style={styles.versionValue} testID="text-version-build">{settings.buildNumber}</Text>
              </View>
            </Card>
          </View>
        </View>
