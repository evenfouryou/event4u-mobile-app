...
export function TicketDetailScreen({
  ...
  const ticket = ticketData ? {
    ...
    price: ticketData.ticketPrice || ticketData.grossAmount || 0,
    holderName: `${ticketData.participantFirstName || ''} ${ticketData.participantLastName || ''}`.trim() || 'N/A',
    fiscalSealCode: ticketData.fiscalSealCode || ticketData.qrCode || 'N/A',
    organizerCompany: ticketData.organizerCompany || 'Organizzatore',
    ticketingManager: ticketData.ticketingManager || 'Biglietteria',
    emissionDateTime: ticketData.emittedAt || ticketData.emissionDateTime ? new Date(ticketData.emittedAt || ticketData.emissionDateTime!) : new Date(),
    progressiveNumber: ticketData.progressiveNumber ? String(ticketData.progressiveNumber).padStart(5, '0') : (ticketData.ticketCode?.slice(-5) || '00000'),
  } : null;
