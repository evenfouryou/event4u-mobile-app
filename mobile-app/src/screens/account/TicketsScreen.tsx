...
export function TicketsScreen({ onBack, onTicketPress, onNavigateLogin, onNavigateRegister }: TicketsScreenProps) {
  ...
  if (!isAuthenticated) {
    return (
      <SafeArea style={authStyles.container} edges={['top']}>
        <View style={authStyles.content}>
          <View style={authStyles.iconContainer}>
            <View style={authStyles.iconRing}>
              <LinearGradient
                colors={['rgba(255, 215, 0, 0.20)', 'rgba(0, 206, 209, 0.12)']}
                style={authStyles.iconGlow}
                start={{ x: 0, y: 0 }}
                end={{ x: 1, y: 1 }}
              >
                <Ionicons name="ticket" size={40} color={staticColors.primary} />
              </LinearGradient>
            </View>
          </View>
          <Text style={authStyles.title}>I tuoi biglietti</Text>
          <Text style={authStyles.subtitle}>
            Accedi per vedere i tuoi biglietti,{'\n'}prenotazioni e QR code per l'ingresso
          </Text>
          <View style={authStyles.buttonContainer}>
            <Button
              ...
              testID="button-tickets-login"
            >
              Accedi
            </Button>
          </View>
          <Pressable onPress={onNavigateRegister} testID="link-tickets-register" style={authStyles.registerContainer}>
            <Text style={authStyles.registerLink}>
              Non hai un account? <Text style={authStyles.registerLinkBold}>Registrati</Text>
            </Text>
          </Pressable>
        </View>
      </SafeArea>
...
const authStyles = StyleSheet.create({
  ...
  iconRing: {
    ...
    borderRadius: 55,
    borderWidth: 1.5,
    borderColor: `${staticColors.primary}18`,
    alignItems: 'center',
    justifyContent: 'center',
    padding: 6,
  },
